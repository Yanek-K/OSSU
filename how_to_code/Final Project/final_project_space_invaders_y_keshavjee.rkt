...
#reader(lib "htdp-beginner-abbr-reader.ss" "lang")((modname final_project_space_invaders_y_keshavjee) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
