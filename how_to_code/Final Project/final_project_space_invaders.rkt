...
(check-random (next-game (make-game empty LOM2 T1))
              (make-game (new-invaders empty)
                         (next-missiles (list (make-missile 150 300)))
                         (make-tank (+ 50 TANK-SPEED) 1)))

(check-random (next-game (make-game empty (list M5) (make-tank 100 1)))
              (make-game (new-invaders empty)
                         (next-missiles (list M5))
                         (make-tank (+ 100 TANK-SPEED) 1)))
  
(check-random (next-game (make-game empty LOM4 T1))
              (make-game (new-invaders empty)
                         (next-missiles LOM4)
                         (make-tank (+ 50 TANK-SPEED) 1)))
...
(check-random (new-invader LOI1) (list (make-invader (random 300) 0 (cond [(< 0.5 (random 2))
                                                                           (- INVADER-SPEED)]
                                                                          [else INVADER-SPEED]))))

(check-random (new-invader LOI2) (list (make-invader (random 300) 0 (cond [(< 0.5 (random 2))
                                                                           (- INVADER-SPEED)]
                                                                          [else INVADER-SPEED])) I1))

(check-random (new-invader (list I4 I2 I1)) (list (make-invader (random 300) 0 (cond [(< 0.5 (random 2))
                                                                                      (- INVADER-SPEED)]
                                                                                     [else INVADER-SPEED])) I4 I2 I1))
